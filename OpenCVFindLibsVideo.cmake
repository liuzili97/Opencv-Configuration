...
if(WITH_FFMPEG)
  ...
  elseif(UNIX OR ANDROID) 
    message("=======HAVE_FFMPEG_CODEC=${HAVE_FFMPEG_CODEC}========")
    set(PKG_CONFIG_PATH = /home/liuzili/test-aarch64/3rdpart-aarch64-install/lib/pkgconfig)
    ...
    message("----------------------HAVE_FFMPEG=${HAVE_FFMPEG}-----------------------")
    if(HAVE_FFMPEG)
      ...
      set(FFMPEG_INCLUDE_DIR "REPLACEME/include")
       message("----------------------FFMPEG_INCLUDE_DIR=${FFMPEG_INCLUDE_DIR}-----------------------") 
      if(FFMPEG_INCLUDE_DIR)
        set(HAVE_GENTOO_FFMPEG TRUE)
        #"${FFMPEG_INCLUDE_DIR}/../lib"
    set(FFMPEG_LIB_DIR "REPLACEME/lib" CACHE PATH "Full path of FFMPEG library directory")
        ...
        set(FFMPEG_CODEC_LIB
                REPLACEME/lib/libavcodec.a)
        set(FFMPEG_XVIDCORE_LIB
                REPLACEME/lib/libxvidcore.a)
        set(FFMPEG_FORMAT_LIB
                REPLACEME/lib/libavformat.a)
        set(FFMPEG_UTIL_LIB
                REPLACEME/lib/libavutil.a)
        set(FFMPEG_SWSCALE_LIB
                REPLACEME/lib/libswscale.a)
        set(Z_LIB
                REPLACEME/lib/libz.a)
        set(X264_LIB
                REPLACEME/lib/libx264.a)
        set(HAVE_FFMPEG_CODEC  1)
        set(HAVE_FFMPEG_FORMAT 1)
        set(HAVE_FFMPEG_UTIL   1)
        set(HAVE_FFMPEG_SWSCALE 1)
        set(HAVE_FFMPEG_RESAMPLE 1)
        message("--${FFMPEG_CODEC_LIB}--${FFMPEG_FORMAT_LIB}")
        ...
        message("=================What!! ${ALIASOF_libavcodec_VERSION}")
      endif(FFMPEG_INCLUDE_DIR)
      if(HAVE_FFMPEG)
        set(HIGHGUI_LIBRARIES ${HIGHGUI_LIBRARIES}
            ${FFMPEG_FORMAT_LIB} ${FFMPEG_CODEC_LIB} ${FFMPEG_XVIDCORE_LIB}
            ${FFMPEG_SWSCALE_LIB} ${FFMPEG_UTIL_LIB} ${Z_LIB} ${X264_LIB})
        message("================What!!! ${HIGHGUI_LIBRARIES}")
        ocv_include_directories(${FFMPEG_INCLUDE_DIR})
        set(CMAKE_INSTALL_RPATH ${FFMPEG_LIB_DIR})
        set(CMAKE_INSTALL_RPATH "${CMAKE_INSTALL_PREFIX}/lib")
        link_directories(${CMAKE_INSTALL_PREFIX})
        message("================INSTALL_RPATH: ${CMAKE_INSTALL_RPATH}")
      endif(HAVE_FFMPEG)
    endif()
  endif()
endif(WITH_FFMPEG)
